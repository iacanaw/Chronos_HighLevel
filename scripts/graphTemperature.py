...
tsv_data = pd.read_csv("data/"+simType+"_SystemTemperature.tsv", sep='\t')
...
fig.savefig("data/"+simType+"_PeakTemperature.png", format='png', dpi=300, bbox_inches='tight')
fig.savefig("data/"+simType+"_PeakTemperature.eps", format='eps', bbox_inches='tight')

with open("data/"+simType+"_ThermalStatistics.csv", "w") as TSfile:
